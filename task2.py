...
root = tk.Tk()
root.title('Scientific Calculator-Varshita')
root.configure(bg='#0000FF')
root.resizable(width=False, height=False)


ent_field = tk.Entry(root, bg='#BEE8F6', fg='#000080', font=('Alice', 24),
                     borderwidth=20, justify="right")
...
for j in range(2, 5):
    for k in range(3):
        button.append(tk.Button(root, text=numberpad[i], font=FONT,
                                fg="green",bg="orange",width=8, height=4,
                                highlightbackground='#BEE8F6', highlightthickness=2))
...
btn_CE = tk.Button(root, text='CE', command=lambda: sc_app.Clear_Entry(),
                   font=FONT, height=4, fg="#000000",bg="pink",
                   highlightbackground='#BEE8F6', highlightthickness=2)
...
btn_sqr = tk.Button(root, text='\u221A', command=lambda: sc_app.SQ_Root(),
                    font=FONT, width=8, height=4, fg="#000000",bg="pink",
                    highlightbackground='#BEE8F6', highlightthickness=2)
...
btn_pi = tk.Button(root, text='\u03C0', command=lambda: sc_app.Pi(),
                   font=FONT, width=9, height=4, fg="#000000",bg="pink",
                   highlightbackground='#BEE8F6', highlightthickness=2)
...
btn_sin = tk.Button(root, text='sin', command=lambda: sc_app.Sin(),
                    font=FONT, width=9, height=4, fg="#000000",
                    highlightbackground='#BEE8F6', highlightthickness=2)
